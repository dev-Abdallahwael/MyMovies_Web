...
export default function NowPlaying() {
  ...
  return (
    ...
    transition={{ duration: 1.5, ease: 'easeOut' }} 
     className='py-4 text-3xl font-semibold font-aladin text-center'><i className="fa-solid fa-circle-play text-red-600"></i> Now playing</motion.h1>

         <div className="grid grid-cols-12 gap-4">
           {/* Card */}
           {/* https://image.tmdb.org/t/p/w500/  => Base URL */}
     
           { !Nowmovies || Nowmovies.length === 0 ? (  <Loader/>  )
           :  
           (
             <>
             {Nowmovies.map((movie)=>{
